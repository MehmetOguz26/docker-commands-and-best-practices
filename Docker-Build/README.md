...
Learn how to build a Docker image, tag it, and push it to Docker Hub. This tutorial covers creating a Docker Hub account, Dockerfile creation, image building, tagging, and pushing to Docker Hub.
...
> **Important Note:** In the commands below, wherever you see `mehmetoguz26`, replace it with your Docker Hub username.
...
> **Note:** Docker Hub sign-in is not required for downloading public images. For example, the Docker image `mehmetoguz26/monginx` is a public image.
...
# Example:
docker run --name monginx -p 8090:80 -d nginx
...
# Example:
docker run --name csnginx -p 8090:80 -d custom-nginx:v1
...
docker tag custom-nginx:v1 YOUR_DOCKER_USERNAME/custom-nginx:v1

# Example with 'mehmetoguz26':
docker tag custom-nginx:v1 mehmetoguz26/custom-nginx:v1

# Push the Docker image to Docker Hub
docker push YOUR_DOCKER_USERNAME/custom-nginx:v1

# Example with 'mehmetoguz26':
docker push mehmetoguz26/custom-nginx:v1
